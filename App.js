    ...
    return(
        <div className="header">
            <div className="logo-container">
                <img className="logo" src="https://img.icons8.com/ios-filled/50/000000/restaurant-menu.png" alt="logo"/>
            </div>
...
const RestaurantCard = (props) => {
    ...
    return (
        <div className="res-card">
            <img className="res-logo" src="https://img.icons8.com/ios-filled/50/000000/restaurant-menu.png" alt="res-logo"/>
            <h3>{name}</h3>
            <h4>{cuisines.join(", ")}</h4>
